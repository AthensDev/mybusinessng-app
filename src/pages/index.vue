                        ...
                        <div class="report-box-2 intro-y mt-5">
                            <div class="box p-5">
                                ...
                                <div class="border-b border-gray-200 flex pb-2 mt-4">
                                    ...
                                    <div class="text-theme-9 flex text-xs font-medium tooltip cursor-pointer ml-auto" title="49% Lower than last month"> 49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                </div>
